...
//#else
  //friend bool bd(tree& x, arma::mat const &Omega, xinfo& xi, dinfo& di, pinfo& pi, RNG& gen);
  //friend double bd(tree &x, arma::mat const &Omega, xinfo &xi, dinfo &di, pinfo &pi, RNG &gen);
  //friend bool bd_rj(int k, tree& x, arma::mat Omega, xinfo& xi, dinfo& di, pinfo& pi, RNG& gen);
  //friend bool bdprec(int k, tree& x, arma::mat Omega, xinfo& xi, dinfo& di, pinfo& pi, RNG& gen);
  //friend bool bdhet(int k, tree& x, arma::mat Omega, xinfo& xi, dinfo& di, double* phi, pinfo& pi, RNG& gen);
//#endif
