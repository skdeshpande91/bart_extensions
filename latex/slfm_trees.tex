...
% maybe also some of the friedman function stuff
% include like a max, logarithm, maybe generate something from a GP with SE x Periodic kernel. 
% Then generate data from the Engelhardt group
